const Carousel = (() => {
    ...
    // JavaScript to handle image click and trigger download
...
//===================================================================================================================================== 
  // Function to show the popup and set the current link in the input field
  function showPopup() {
    const popup = document.getElementById("sharePopup");
    const overlay = document.querySelector(".overlay");
    const linkInput = document.getElementById("linkInput");
    linkInput.value = window.location.href; // Set the current page URL
...
function copyLink() {
    ...
    // Alert to notify the user that the link has been copied
